...
public record ClaimChunkEditResult(
    ...
    public static ClaimChunkEditResult success(
        ...
        return new ClaimChunkEditResult(action, claims, Optional.empty(), Optional.of(auditEntry), affectedChunks);
    }
    ...
    public static ClaimChunkEditResult failure(
        ...
        return new ClaimChunkEditResult(action, List.of(), Optional.of(failure), Optional.empty(), affectedChunks);
    }
}
